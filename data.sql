...
('Natalia Dragomiroff', 'Movimento de fundos suspeitos conectados a família aristocrática envolvida em caso de sequestro.', 1930, 'Aberto'),
('Mary Debenham', 'Investigação de envolvimento profissional com família-alvo de caso criminal de 1930.', 1930, 'Aberto'),
('Arbuthnot', 'Investigação de conhecimento de crime contra família aristocrática. Relacionamento com envolvida.', 1930, 'Aberto'),
('Caroline Hubbard', 'Investigação de laços familiares com vítima de sequestro de 1930. Possível herdeira.', 1930, 'Aberto'),
('Greta Ohlsson', 'Investigação de envolvimento profissional com criança sequestrada em 1930. Culpa psicológica.', 1930, 'Aberto'),
('Antonio Foscarelli', 'Investigação de emprego com família-alvo de crime grave. Conhecimento de movimentos suspeitos.', 1930, 'Aberto'),
('Cyrus Hardman', 'Investigação de envolvimento emocional com caso Armstrong. Relacionamento com criança afetada.', 1930, 'Aberto'),
('Countess Andrenyi', 'Investigação de conexão familiar com envolvida em caso de sequestro de 1930.', 1930, 'Aberto'),
('Helene Armstrong', 'Viúva de vítima colateral. Envolvimento em caso criminal que destruiu sua família.', 1930, 'Aberto'),
('Vladimir Armstrong', 'Parente de vítima de sequestro de 1930. Possível envolvimento em investigação privada.', 1930, 'Aberto'),
